...
declare interface Serializer {
    deserialize<T>(type: string, data: DocWithData, schema?: string): T;

    serialize<T extends DocWithData>(type: string, data: any, schema?: string, extraData?: object): T;

    serialize<T extends DocWithData>(type: string, data: any, extraData?: object): T;

    serialize<T extends DocWithData>(type: string, data: any, schema?: string): T;
}

declare interface Response extends EResponse {
    jsonapi(modelName: string, data: object, pagination?: object);
}

type PruneModel<T, K> = Pick<T, Exclude<keyof T, keyof K>>

export declare module AutoMapperJs {
    /**
    ...
    class AutoMapper {
         ...
         */
        createMap(sourceKey: string | (new() => any),
                  destinationKey: string | (new() => any)): ICreateMapFluentFunctions;
         ...
         */
        mapAsync(sourceKey: string | (new() => any)): (destinationKey: string | (new() => any),
                                                       sourceObject: any,
         ...
         */
        mapAsync(sourceKey: string | (new() => any),
         ...
         */
        mapAsync(sourceKey: string | (new() => any), destinationKey: string | (new() => any)): (sourceObject: any,
                                                                                                callback: IMapCallback) => void;
    ...
    interface IDestinationTransformation {
        ...
        asyncSourceMemberConfigurationOptionsFunc?: (opts: ISourceMemberConfigurationOptions,
                                                     cb: IMemberCallback) => void;
    }
    ...
    interface ICreateMapFluentFunctions {
         ...
         * @returns {IAutoMapperCreateMapChainingFunctions}
         */
        forAllMembers: (func: (destinationObject: any,
                               destinationPropertyName: string,
                               value: any) => void) => ICreateMapFluentFunctions;
...
declare interface Environment {
    ...
    database?: any;
    cache?: object | false;
    type?: 'dev' | 'local' | 'int' | 'prod';
    numProcesses?: string;
    // "numProcesses": require('os').cpus().length
    apiLogFilename?: string;
    logging?: {
        logDir?: string;
        storeToCloudLogs?: boolean;
        level?: LoggingLevel;
        includePid?: boolean;
    };
    local?: boolean;
